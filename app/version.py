...
the CI workflows. Change the version in this one file and nowhere else.
    ...
    python -m app.version          # prints 1.0.0
    python -m app.version --windows  # prints 1.0.0.0
"""
...
def version_tuple() -> tuple[int, int, int]:
    """``(1, 0, 0)`` -- the numeric parts, ignoring any pre-release label."""
...
def windows_version(build: int = 0) -> str:
    """``1.0.0.0`` -- the four-part form Windows file metadata and MSI require.
